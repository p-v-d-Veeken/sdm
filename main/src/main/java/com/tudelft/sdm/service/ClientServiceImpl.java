...
public class ClientServiceImpl implements ClientService{
    ...
    @Override
    @Transactional
    public Client find(int id, KeyringData keyring) {
    ...
    @Override
    @Transactional
    public Void create(ModelApiClient apiClient, KeyringData keyring) {
    ...
    @Override
    @Transactional
    public Void update(int id, ModelApiClient apiClient, KeyringData keyring) {
    ...
    @Override
    @Transactional
    public Void delete(int id, KeyringData keyring) {
        Client client = this.find(id, keyring);
    ...
    @Override
    @Transactional
    public List<Client> getAll(KeyringData keyring) {
